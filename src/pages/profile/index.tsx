    ...
    <Layout>
      <div className="flex justify-center">
        <div className="border max-w-3xl w-full">
          <h3 className="text-center text-white bg-slate-800 text-lg p-2">
            Profile
          </h3>
          <div className="p-8 pb-4 border-b">
            <div className="flex flex-row items-center mb-2">
              <div className="mr-2">
                {userInfo?.photoURL ?    <img src={userInfo.photoURL} alt="" className="w-28 h-28 rounded-full border-2 border-slate-800 object-cover" /> :
          ...
          <div className="p-8">
            <div className="mb-5">My Posts</div>
